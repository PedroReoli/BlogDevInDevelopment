    ...
    <footer className="border-t border-border bg-card">
      <div className="container py-8 md:py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="font-heading text-lg font-semibold mb-4">Categorias</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/blog?tag=javascript" className="text-muted-foreground hover:text-primary transition-colors">
                  JavaScript
                </Link>
              </li>
              <li>
